...
function draw() {
  ...
  newline(mouseX + int(magnitude * cos(netAngle)), mouseY - int(magnitude * sin(netAngle)), mouseX + int(magnitude * cos(netAngle + PI / 3) * 1 / 5), mouseY - int(magnitude * sin(netAngle + PI / 3) * 1 / 5));
  newline(mouseX + int(magnitude * cos(netAngle)), mouseY - int(magnitude * sin(netAngle)), mouseX + int(magnitude * cos(netAngle - PI / 3) * 1 / 5), mouseY - int(magnitude * sin(netAngle - PI / 3) * 1 / 5));
  }
}
